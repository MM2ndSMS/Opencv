...
Point2f Source[]={Point2f(0,0),Point2f(-300,340),Point2f(640,0),Point(640+300,340)};
...
int main(void)
{
    ...
    mat_image_org_color = imread("/home/pi/opencv/7/Untitled.png");
    ...
    while(1)
    {
        ...
        for(int i=0; i<linesP.size();i++)
        {
            ...
            line(mat_image_org_color,Point(L[0],L[1]),Point(L[2],L[1]), Scalar(0,0,255), 3, LINE_AA);
